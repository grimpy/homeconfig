...
shiftytags = {
    ...
    ["5:fs"] = { position=5, key=5, exclusive=true, spawn="thunar", layout=awful.layout.suit.floating, screen=LCD},
...
keybindings = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "F7", function () awful.util.spawn(binhome .. "xrandr.sh --toggle") end),    awful.key({ modkey,           }, "x", xbmckeyhandler),
